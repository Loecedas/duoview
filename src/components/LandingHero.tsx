...
export default function LandingHero() {
    ...
    return (
        <div className={`min-h-screen flex flex-col justify-between items-center px-4 pt-10 pb-6 relative ${isDark ? 'bg-[#0f172a]' : 'bg-[#f0f4f8]'}`} data-theme={resolvedTheme}>
            {/* Theme Toggle */}
            ...
            {/* Footer */}
            <footer className={`pt-4 pb-2 text-center text-xs ${isDark ? 'text-slate-500' : 'text-gray-400'}`}>
                © 2026 · DuoView 非官方工具
            </footer>
        </div>
    );
